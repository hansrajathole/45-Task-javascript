  ...
  return (
    <div className='min-h-screen w-full flex bg-gray-300 justify-center gap-5 flex-wrap'>
        {RealData.map((elem,index)=>{
           ...
           return <div className='w-[20%] h-[70%] border-2 border-black rounded-lg bg-white mt-4 py-2 px-4'>
               <div className="img flex justify-center flex-col">
                <img src={elem.profilePhoto} className='w-[200px] h-[200px] rounded-full object-cover object-top mx-auto' alt="" />
               ...
               <div>
                ...
                <div>
                  <button onClick={()=>eventHandle(index)} className={`w-full ${elem.available?"bg-red-500":"bg-green-600"} py-1 rounded-lg active:scale-90 font-semibold`}>{elem.available?"remove friend":"Add friend"}</button>
                </div>
               </div>
            </div>
